...
const QuestionHeader = () => {
  ...
  return (
    <div className='xl:ml-56 lg:ml-52 xl:w-10/12 lg:w-9/12 w-full flex relative flex-col space-y-4 px-4 py-6'>
        ...
        <div className='flex justify-between md:w-8/12 space-y-4'>
           <div className='w-full flex flex-wrap text-sm items-center'>
           ...
           <button className='xl:px-8 md:px-3 px-2 text-white py-2 xl:text-[15px] lg:text-[12px] md:text-[10px] text-[13px] rounded-full font-semibold bg-blue-500 whitespace-nowrap'>ASK QUESTIONS</button>
        </div>
    </div>
  )
}
